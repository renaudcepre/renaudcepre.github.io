...
![Status](https://img.shields.io/badge/status-en_pause-yellow) [![Github](https://img.shields.io/badge/github-repo-blue?logo=github)](https://github.com/renaudcepre/felix)
...
- **Eval-first** — chaque comportement du moteur a son éval rejouable
  avec [apte](/dev/projects/apte/README.md) : unitaires,
...
J'ai touché un mur assez net entre ce que je voulais faire et ce que
les petits modèles que j'utilisais pouvaient faire. L'extraction tient.
Le raisonnement narratif, la fusion d'entités entre des scènes écrites
à des mois d'intervalle, la retenue (ne rien écrire sur un simple
« salut »), non : un 7B invente, et mistral-small invente encore. Les
garde-fous limitent les dégâts, ils ne remplacent pas un modèle qui
comprend le récit.

## Statut

En pause depuis juin 2026, point de reprise documenté dans le
journal. Le moteur tourne sur un vrai scénario et « scénario »
n'est qu'un profil parmi d'autres (un profil « chantier » existe).
